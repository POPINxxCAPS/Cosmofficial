...
const getRemoteConfig = require('./getRemoteConfig');
const getEconomySettings = require('./getEconomySettings');
const getLotterySettings = require('./getLotterySettings');
const getHotzoneSettings = require('./getHotzoneSettings');
const getChannelSettings = require('./getChannelSettings');
const getHooverSettings = require('./getHooverSettings');
